...
int main()
{
    ...
    while (true)
    {
        ...
        std::cout << "3. Démonstration Communication ECU" << std::endl;
        ...
        std::cout << "7. Test de reception" << std::endl;
        std::cout << "8. Test de reception avec Ecu" << std::endl;
